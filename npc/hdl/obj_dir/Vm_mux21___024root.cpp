...
VL_INLINE_OPT void Vm_mux21___024root___combo__TOP__1(Vm_mux21___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vm_mux21__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vm_mux21___024root___combo__TOP__1\n"); );
    // Body
...
QData Vm_mux21___024root___change_request_1(Vm_mux21___024root* vlSelf);

VL_INLINE_OPT QData Vm_mux21___024root___change_request(Vm_mux21___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vm_mux21__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vm_mux21___024root___change_request\n"); );
    // Body
    return (Vm_mux21___024root___change_request_1(vlSelf));
}

VL_INLINE_OPT QData Vm_mux21___024root___change_request_1(Vm_mux21___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vm_mux21__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vm_mux21___024root___change_request_1\n"); );
    // Body
    // Change detection
