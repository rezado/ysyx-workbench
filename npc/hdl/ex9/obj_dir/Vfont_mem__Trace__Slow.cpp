...
void Vfont_mem___024root__traceInitSub0(Vfont_mem___024root* vlSelf, VerilatedVcd* tracep) VL_ATTR_COLD;
...
void Vfont_mem___024root__traceInitTop(Vfont_mem___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        Vfont_mem___024root__traceInitSub0(vlSelf, tracep);
    }
}

void Vfont_mem___024root__traceInitSub0(Vfont_mem___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vfont_mem__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
void Vfont_mem___024root__traceFullTop0(void* voidSelf, VerilatedVcd* tracep) VL_ATTR_COLD;
void Vfont_mem___024root__traceChgTop0(void* voidSelf, VerilatedVcd* tracep);
void Vfont_mem___024root__traceCleanup(void* voidSelf, VerilatedVcd* /*unused*/);
...
void Vfont_mem___024root__traceRegister(Vfont_mem___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        tracep->addFullCb(&Vfont_mem___024root__traceFullTop0, vlSelf);
        tracep->addChgCb(&Vfont_mem___024root__traceChgTop0, vlSelf);
        tracep->addCleanupCb(&Vfont_mem___024root__traceCleanup, vlSelf);
    }
}

void Vfont_mem___024root__traceFullSub0(Vfont_mem___024root* vlSelf, VerilatedVcd* tracep) VL_ATTR_COLD;

void Vfont_mem___024root__traceFullTop0(void* voidSelf, VerilatedVcd* tracep) {
    Vfont_mem___024root* const __restrict vlSelf = static_cast<Vfont_mem___024root*>(voidSelf);
    Vfont_mem__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    {
        Vfont_mem___024root__traceFullSub0((&vlSymsp->TOP), tracep);
    }
}

void Vfont_mem___024root__traceFullSub0(Vfont_mem___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vfont_mem__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
