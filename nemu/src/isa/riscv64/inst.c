...
// word_t MIE = BITS(cpu.csr[MSTATUS], 8, 8); if (MIE == 1) cpu.csr[MSTATUS] |= 0x10000000; else cpu.csr[MSTATUS] &= ~0x10000000; cpu.csr[MSTATUS] |= 0x8
  ...
  INSTPAT("0011000 00010 00000 000 00000 11100 11", mret   , N, printf("pc:%lx\n", s->pc); s->dnpc = cpu.csr[MEPC] + 4; printf("newpc:%lx\n", s->dnpc); word_t MIE = BITS(cpu.csr[MSTATUS], 8, 8); if (MIE == 1) cpu.csr[MSTATUS] |= 0x10000000; else cpu.csr[MSTATUS] &= ~0x10000000; cpu.csr[MSTATUS] |= 0x8);
